...
All reads in $$get_k$$ happens-before reads in $$get_i$$ and values of the registers are never decremented. Consequently, all reads performed by $$get_i$$ yield values greater than or equal to ones yielded by reads in $$get_k$$, and $$res_i \geq res_k$$.
